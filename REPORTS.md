...
************* Module core.board
core/board.py:27:0: C0303: Trailing whitespace (trailing-whitespace)
core/board.py:1:0: C0114: Missing module docstring (missing-module-docstring)
core/board.py:10:4: C0116: Missing function or method docstring (missing-function-docstring)
core/board.py:13:4: C0116: Missing function or method docstring (missing-function-docstring)
core/board.py:23:8: R1705: Unnecessary "else" after "return", remove the "else" and de-indent the code inside it (no-else-return)
core/board.py:29:4: C0116: Missing function or method docstring (missing-function-docstring)
core/board.py:53:4: C0116: Missing function or method docstring (missing-function-docstring)
core/board.py:98:8: R1705: Unnecessary "elif" after "return", remove the leading "el" from "elif" (no-else-return)
core/board.py:74:4: R0911: Too many return statements (7/6) (too-many-return-statements)
core/board.py:127:4: C0116: Missing function or method docstring (missing-function-docstring)
core/board.py:128:8: R1705: Unnecessary "else" after "return", remove the "else" and de-indent the code inside it (no-else-return)
************* Module core.player
...
pygame_ui/game_window.py:13:4: W0621: Redefining name 'n1' from outer scope (line 243) (redefined-outer-name)
pygame_ui/game_window.py:14:4: W0621: Redefining name 'n2' from outer scope (line 243) (redefined-outer-name)
...
pygame_ui/game_window.py:42:8: C0103: Attribute name "FONT" doesn't conform to snake_case naming style (invalid-name)
pygame_ui/game_window.py:18:0: R0902: Too many instance attributes (20/7) (too-many-instance-attributes)
pygame_ui/game_window.py:19:37: W0621: Redefining name 'screen' from outer scope (line 245) (redefined-outer-name)
pygame_ui/game_window.py:45:4: C0116: Missing function or method docstring (missing-function-docstring)
pygame_ui/game_window.py:92:4: C0116: Missing function or method docstring (missing-function-docstring)
pygame_ui/game_window.py:99:4: C0116: Missing function or method docstring (missing-function-docstring)
pygame_ui/game_window.py:123:4: C0116: Missing function or method docstring (missing-function-docstring)
pygame_ui/game_window.py:133:8: R1705: Unnecessary "else" after "return", remove the "else" and de-indent the code inside it (no-else-return)
pygame_ui/game_window.py:140:4: C0116: Missing function or method docstring (missing-function-docstring)
pygame_ui/game_window.py:145:4: C0116: Missing function or method docstring (missing-function-docstring)
pygame_ui/game_window.py:154:4: C0116: Missing function or method docstring (missing-function-docstring)
pygame_ui/game_window.py:154:4: R0912: Too many branches (16/12) (too-many-branches)
pygame_ui/game_window.py:220:4: C0116: Missing function or method docstring (missing-function-docstring)
pygame_ui/game_window.py:225:33: E1101: Module 'pygame' has no 'QUIT' member (no-member)
pygame_ui/game_window.py:227:20: E1101: Module 'pygame' has no 'quit' member (no-member)
pygame_ui/game_window.py:229:33: E1101: Module 'pygame' has no 'KEYDOWN' member (no-member)
pygame_ui/game_window.py:229:65: E1101: Module 'pygame' has no 'K_SPACE' member (no-member)
pygame_ui/game_window.py:232:33: E1101: Module 'pygame' has no 'MOUSEBUTTONDOWN' member (no-member)
pygame_ui/game_window.py:244:4: E1101: Module 'pygame' has no 'init' member (no-member)
...
************* Module cli.main
cli/main.py:1:0: C0114: Missing module docstring (missing-module-docstring)
cli/main.py:1:0: C0410: Multiple imports on one line (sys, os) (multiple-imports)
cli/main.py:4:0: C0413: Import "from core.board import Board" should be placed at the top of the module (wrong-import-position)
cli/main.py:5:0: C0413: Import "from core.dice import Dice" should be placed at the top of the module (wrong-import-position)
cli/main.py:6:0: C0413: Import "from core.player import Player" should be placed at the top of the module (wrong-import-position)
cli/main.py:7:0: C0413: Import "from core.game import BackgammonGame" should be placed at the top of the module (wrong-import-position)
cli/main.py:21:21: W0613: Unused argument 'color' (unused-argument)
cli/main.py:36:0: C0116: Missing function or method docstring (missing-function-docstring)
cli/main.py:36:0: R0914: Too many local variables (17/15) (too-many-locals)
cli/main.py:45:4: W0612: Unused variable 'game' (unused-variable)
